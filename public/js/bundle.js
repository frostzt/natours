...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZnJvc3R6IiwiYSI6ImNrZmF6eWg2YzExN28ycW1xZzVpYzVtZ2cifQ.CR7wq5rOaOqQlMn7agKDTQ';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)(res.data.status, 'Account created successfully!');
              window.setTimeout(function () {
                location.assign('/me');
              }, 1500);
            }
...
var stripe = Stripe('pk_test_51HYrAEHnRJNf1Vr0AHnKsLO3D5njIfkcSxn30R7TsyC95qlVssPs4AfiKsdgF4jIymy4VQpQhKaLZMrvSeFGkSFo00ARhbm3iM');
...
var myReview = document.querySelector('.my-reviews');
var deleteBtn = document.getElementById('delete-review');
var updateBtn = document.getElementById('update-review'); // Delegation
...
function confirmAction(id, type) {
  ...
  if (type === 'delete') {
    ...
    var _confirmYes = document.getElementById('confirm-yes');

    _confirmYes.addEventListener('click', function () {
      _confirmYes.textContent = 'Updating...';
      var review = document.getElementById('review_text').value;
      (0, _updateReview.updateReview)(id, review);
    });
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "5756" + '/');
